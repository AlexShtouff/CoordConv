...
function renderSavedPoints() {
    ...
    savedPoints.forEach((point, index) => {
        const distanceText = userLocation ?
            `${calculateDistance(userLocation.latitude, userLocation.longitude, point.latitude, point.longitude).toFixed(2)} m` :
            'N/A';
        ...
        pointDiv.innerHTML = `
            ...
            <div class="point-body">
                ...
                <div class="point-distance">
                    Distance to My Location: <strong>${distanceText}</strong>
                </div>
            </div>
        `;
